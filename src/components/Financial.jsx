...
function Financial() {
  ...
  <div className="flex-1">
    <Link to="/financialpage" className="text-xl font-bold text-green-600 block p-2 bg-green-300 text-white rounded-lg hover:bg-green-600">
        💰 Financial
      </Link>
    <p className="text-sm text-gray-700">💰 Stable | ⚠ Review Expenses</p>
    {advice && <p className="text-sm mt-2 text-green-700">{advice}</p>}
  </div>
