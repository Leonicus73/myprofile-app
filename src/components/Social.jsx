...
function Social() {
  ...
  return (
    <div className="bg-orange-100 p-4 rounded-lg shadow-md flex justify-between items-center">
  <div className="flex-1">
    ...
    <button onClick={getAdvice} className="ml-4 p-2 bg-orange-500 text-white rounded-lg whitespace-nowrap">
      Advice
    </button>
    </div>
  );
